...
CREATE TABLE `products` (
  ...
  `pdtImage` varchar(45) NOT NULL,
  `pdtDescription` varchar(45) NOT NULL,
  `pdtCapacity` varchar(45) NOT NULL,
  `pdtPrice` varchar(45) NOT NULL,
...
CREATE TABLE `shopping` (
  ...
  CONSTRAINT `Products_pdtID` FOREIGN KEY (`Products_pdtID`) REFERENCES `products` (`pdtID`),
...
CREATE TABLE `shopping_cart` (
  ...
  CONSTRAINT `fk_Shopping_cart_Usuarios1` FOREIGN KEY (`Usuarios_userID`) REFERENCES `usuarios` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-13 16:11:18
